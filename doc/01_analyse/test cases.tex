...
\subsection{Scope}
Device Tests testen ein einzelnes Netzwerkgerät. Häufig geht es bei den Device Tests um Konfigurationsvergleiche. Durch einen solchen ConfigDiff kann man extrem viel testen.
\subsection{Nutzen}
